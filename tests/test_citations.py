...
def test_remove_latex_comments_newline_edge_case():
    ...
    # We assert the ideal output. The regex will fail and return the comment.
    assert remove_latex_comments(text) == "End of line \\\\ "

@pytest.mark.parametrize("input_text, expected_citations", [
...
@pytest.mark.parametrize("body, field, expected", [
    ('author = {Smith, John and Doe, Jane},\nyear = {2020}', 'author', 'Smith, John and Doe, Jane'),
...
def test_extract_bib_field_concatenation_failure():
    ...
    # We assert the correct combined string. The custom parser will only return "Smith, John".
...
def test_search_author_citations_logic():
    ...
    # We pass 'smith' - it should ignore case and find it.
    ...
    # locations will be empty because chapter1.tex doesn't physically exist in this unit test
